...
public class Test2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("2. oracle/mySQL");
		...
		System.out.println("1. 자바 언어는 독립적이다.");
		System.out.println("2. 자바 언어는 고급언어이다.");
		System.out.println("3. 자바 언어는 객체지향 언어이다.");
		System.out.println("4. 자바 언어는 C와 유사하다.");
